...
## Getting Started
Users are assumed have read through [Adafruit's PyPortal learning guide](https://learn.adafruit.com/adafruit-pyportal). CircuitPython v10.0 is currently in use for this repository, no other versions are evaluated & reverse compatibility is not guaranteed.
