...
COMPILERS = {
    "Windows": Path("./mpy-cross/mpy-cross-windows-10.3.0.static.exe"),
    "Linux": Path("./mpy-cross/mpy-cross-linux-amd64-10.3.0.static"),
    "Darwin": Path("./mpy-cross/mpy-cross-macos-10.3.0-arm64"),
}
